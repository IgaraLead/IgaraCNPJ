...
class TableSchema:
    ...
    def get_cnae_schema() -> Dict[str, str]:
        return {"codigo": "INTEGER NOT NULL", "descricao": "TEXT"}
    ...
    def get_dtype_mapping(table_name: str) -> Dict[str, str]:
        ...
        mappings = {
            ...
            "cnae": {"codigo": "Int64", "descricao": "str"},
            "moti": {"codigo": "Int64", "descricao": "str"},
            "munic": {"codigo": "Int64", "descricao": "str"},
            "natju": {"codigo": "Int64", "descricao": "str"},
            "pais": {"codigo": "Int64", "descricao": "str"},
            "quals": {"codigo": "Int64", "descricao": "str"},
        }
